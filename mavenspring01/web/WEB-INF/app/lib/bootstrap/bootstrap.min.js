...
!function (a) {
    ...
    b.prototype = {
        constructor: b, toggle: function () {
            ...
            this.$element.trigger(c, this.$element.attr("id"));
            if (this.isShown || c.isDefaultPrevented())return;
            this.isShown = !0, this.escape(), this.backdrop(function () {
                var c = a.support.transition && b.$element.hasClass("fade");
                var elementId = b.$element.attr("id");
                b.$element.parent().length || b.$element.appendTo(document.body), b.$element.show(), c && b.$element[0].offsetWidth, b.$element.addClass("in").attr("aria-hidden", !1), b.enforceFocus(), c ? b.$element.one(a.support.transition.end, function () {
                        b.$element.focus().trigger("shown",elementId)
                    }) :
                    b.$element.focus().trigger("shown",elementId)
            })
        }, hide: function (b) {
            b && b.preventDefault();
            var c = this;
            b = a.Event("hide"), this.$element.trigger(b, this.$element.attr("id"));
            ...
            this.$element.hide().trigger("hidden", this.$element.attr("id")), this.backdrop()
        }, removeBackdrop: function () {
            this.$backdrop.remove(), this.$backdrop = null
        }, backdrop: function (b) {
            var c = this, d = this.$element.hasClass("fade") ? "fade" : "";
            // add by liyuying 20170622
            var backdrop = $(".modal-backdrop");
            // if (this.isShown && this.options.backdrop && $(backdrop).length == 0) {
            if (false){
